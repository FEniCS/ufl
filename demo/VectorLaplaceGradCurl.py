...
# elements.
from ufl import (Coefficient, FiniteElement, FunctionSpace, Mesh, TestFunctions, TrialFunctions, curl, dx, grad, inner,
                 tetrahedron)
...
GRAD = FiniteElement("Lagrange", cell, order, (), (), "identity", H1)
CURL = FiniteElement("N1curl", cell, order, (3, ), (3, ), "covariant Piola", HCurl)
