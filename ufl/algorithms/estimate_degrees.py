...
class SumDegreeEstimator(MultiFunction):
    ...
    def _not_handled(self, v, *args):
        ...
        raise ValueError(f"Missing degree handler for type {v.__class__.__name__}")
    ...
    def expr(self, v, *ops):
        ...
        """
        warnings.warn(f"Missing degree estimation handler for type {v.__class__.__name__}")
