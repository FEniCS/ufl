...
class GenericDerivativeRuleset(DAGTraverser):
    ...
    def __init__(
        self, var_shape: tuple, compress=True, visited_cache=None, result_cache=None
    ) -> None:
        """Initialise."""
...
class ReferenceGradRuleset(GenericDerivativeRuleset):
    ...
    def __init__(self, topological_dimension, compress=True, visited_cache=None, result_cache=None):
        """Initialise."""
        super().__init__(
...
class VariableRuleset(GenericDerivativeRuleset):
    ...
    def __init__(self, var, compress=True, visited_cache=None, result_cache=None):
        """Initialise."""
        super().__init__(
