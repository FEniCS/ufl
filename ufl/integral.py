...
class Integral(object):
    ...
    def __init__(
        ...
        if additional_domain_integral_type_map is None:
            ...
            self._additional_domain_integral_type_map = {
                d: additional_domain_integral_type_map[d]
    ...
    def reconstruct(
        ...
        if additional_domain_integral_type_map is None:
            additional_domain_integral_type_map = self._additional_domain_integral_type_map
        return Integral(
            integrand,
            integral_type,
            domain,
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"additional_domain_integral_type_map={self._additional_domain_integral_type_map!r})"
        )
